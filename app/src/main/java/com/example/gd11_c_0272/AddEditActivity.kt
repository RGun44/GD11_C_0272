package com.example.gd11_c_0272
...
import com.example.gd11_c_0272.api.MahasiswaApi
import com.example.gd11_c_0272.models.Mahasiswa
...
class AddEditActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var btnCancel = findViewById<Button>(R.id.btn_cancel)
    ...
    private fun updateMahasiswa(id: Long) {
        ...
        val stringRequest: StringRequest =
            object : StringRequest(Method.PUT, MahasiswaApi.UPDATE_URL, Response.Listener { response ->
                val gson = Gson()
                var mahasiswa = gson.fromJson(response, Mahasiswa::class.java)
